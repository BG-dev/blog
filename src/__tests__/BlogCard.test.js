...
describe('BlogCard Component', () => {
    ...
    it('has an "h2" tag and title equel text content', () => {
        const component = ReactTestUtils.renderIntoDocument(<BlogCard data={cardData}/>);    
        let h2 = ReactTestUtils.findRenderedDOMComponentWithTag(
         component, 'h2'
        );
        expect(h2.textContent).toEqual(cardData.node.title);
    });
    ...
    it('author Name equel text content', () => {
        ...
        expect(p.textContent).toEqual(cardData.node.authorName);
    });
